...
import Migration0017 from "./Migrations/017_ProjectionThreadsAutoContinuePersistence.ts";
import Migration0018 from "./Migrations/018_ProjectionDelayedSends.ts";
...
export const migrationEntries = [
  ...
  [17, "ProjectionThreadsAutoContinuePersistence", Migration0017],
  [18, "ProjectionDelayedSends", Migration0018],
] as const;
